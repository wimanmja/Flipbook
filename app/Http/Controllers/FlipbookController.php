...
class FlipbookController extends Controller
{
    ...
    public function index()
    {
      ...
      // return view('flipbook::time', compact('current_time'));
        ...
        return view('bookindex', compact('flipbooks'));
    }
      ...
      //  return dd($input);
        ...
        //if($request->hasFile('flip_img'))
        {
           ...
           // $name = $uploadedFile->getClientOriginalName();
            ...
            $i++;
            $file = $uploadedFile->move(public_path('public/turnjs/pics/'), $filename);
           //$path = public_path('rudra/flipbook/pics/' . $filename);
            $path = 'public/turnjs/pics/' . $filename;
    ...
    public function show($id)
    {
       ...
       //dd($flipbook);
        ...
        return view('showbook',compact('flipbook','content'));
    }
    ...
    public function edit($id)
    {
        $flipbook = DB::table('flipbook')->where('id', $id)->get()[0];
        $content = explode(",",$flipbook->content);
        return view('editbook',compact('flipbook','content'));
    }
