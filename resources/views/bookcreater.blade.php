<html>
  ...
  <body>
    <div class="container">
      ...
      <!-- SCRIPTS -->
      <form class="register-form" method="POST" action="{{ route('flipbook.store') }}" enctype="multipart/form-data"> {!! csrf_field() !!} <div class="row">
          <div class="col-lg-3">
            <label>
        ...
        <div class="row">
          ...
          <div class="col-lg-9">
            <input class="input-block-level" type="text" placeholder="* Flip Book Desc" name="desc" value="">
          </div>
        </div>
        <div id="browse_file">
          <div class="row">
  ...
  <script type="text/javascript">
    $(document).ready(function() {
      var i = 2; // Counter for image input field names

      $("#add_files").on('click', function() {
        // Construct HTML string for a new image input field row
        var data = '<div class="row">' +
                    '<div class="col-lg-3">' +
                      '<label>' +
                        '<span class="required">*</span> Select Flipbook Image' +
                      '</label>' +
                    '</div>' +
                    '<div class="col-lg-9">' +
